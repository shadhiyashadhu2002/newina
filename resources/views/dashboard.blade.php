...
.teal { background: linear-gradient(135deg, #009688, #00796b); }
.red { background: linear-gradient(135deg, #F44336, #d32f2f); }
.dark-green { background: linear-gradient(135deg, #388E3C, #2e7d32); }
