...
<body>
    ...
    <header class="main-header">
        <a href="{{ route('dashboard') }}" class="header-brand">INA</a>
        ...
        <nav>
            <ul class="header-nav">
                ...
                <li><a href="{{ route('shortlist.ina') }}" class="active">Shortlist INA</a></li>
                <li><a href="{{ route('shortlist.others') }}">Shortlist Others</a></li>
    ...
    <div class="page-container">
        ...
        <h1 class="form-title">Search Profiles</h1>
        
        <form id="searchProfilesForm" method="POST" action="#">
            @csrf
