    ...
    <header class="main-header">
        ...
        <nav>
            <ul class="header-nav">
                ...
                <li><a href="{{ route('shortlist.ina') }}">Shortlist INA</a></li>
                <li><a href="{{ route('shortlist.others') }}" class="active">Shortlist Others</a></li>
    ...
    <div class="page-container">
        ...
        <form id="assignProfileForm" method="POST" action="{{ route('assign.profile') }}">
            ...
            <div class="form-group">
                ...
                <div class="error-message" id="contactError">Please enter valid contact numbers</div>
            </div>
